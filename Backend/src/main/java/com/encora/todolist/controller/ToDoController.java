...
public class ToDoController {
    ...
    @GetMapping("/todos")
    public ResponseEntity<List<ToDo>> getToDos(@RequestBody SearchDTO dto) {
    ...
    @PutMapping("todos/{id}")
    public ResponseEntity<String> updateToDo(@PathVariable("id") Long id, @RequestBody ToDoDTO dto) {
